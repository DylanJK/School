<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="staff.aspx.cs" Inherits="appSchool.setup.staff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph1" runat="server">
                ...
                <tr>
                    ...
                    <td style="text-align: right; width: 154px">
                        <asp:DropDownList ID="cboActive" Width="150px" CssClass="combobox" runat="server" AutoPostBack="true"
                            ...
                            <asp:ListItem Text="All Staff" Value="1"></asp:ListItem>
                            <asp:ListItem Text="Active Staff" Value="2" Selected="True"></asp:ListItem>
                            <asp:ListItem Text="Inactive Staff" Value="3"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>
    ...
    <div class="placeholder" style="width: 764px;">
        ...
        <div class="listbox" style="width: 740px">
            <div class="dialogpanel">
                ...
                <asp:GridView ID="grdStaff" runat="server" AutoGenerateColumns="false" CellPadding="4"
                    GridLines="None" CssClass="grid" Width="100%" OnRowCommand="grdStaff_RowCommand">
                    ...
                    <Columns>
                        <asp:BoundField DataField="StaffId">
                        ...
                        <asp:TemplateField ShowHeader="False" ItemStyle-Width="70px" ItemStyle-HorizontalAlign="Center" HeaderText="Remove">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkremove" Width="70px" Height="26px" ToolTip="Remove Staff" runat="server"
                                    CssClass="removeimage" CausesValidation="False" CommandName="RemoveRow"
                                    CommandArgument="<%# Container.DataItemIndex %>" OnClientClick="return confirm('Are you sure you want to remove Staff?');" />
                            </ItemTemplate>
                        ...
                        <asp:TemplateField ShowHeader="False" ItemStyle-HorizontalAlign="Center" HeaderText="Edit" HeaderStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkedit" Width="70px" Height="26px" ToolTip="Edit Staff"
    ...
    <asp:HiddenField ID="hdfStaffId" Visible="false" runat="server" />
